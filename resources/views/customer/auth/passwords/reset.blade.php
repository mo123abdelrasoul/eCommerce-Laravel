...
@section('title', 'Reset Password - Mstore24')
    ...
    <div class="min-h-[60vh] flex flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-50">
        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div class="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
                ...
                <form class="space-y-6" action="{{ route('user.password.update', app()->getLocale()) }}" method="POST">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="mt-1">
                            <input id="email" type="email" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 bg-gray-100 text-gray-500 sm:text-sm" value="{{ request('email') }}" readonly>
                        </div>
                    </div>
