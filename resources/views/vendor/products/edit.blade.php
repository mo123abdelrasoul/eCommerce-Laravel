    ...
    <div class="dashboard-container flex min-h-screen">
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">Edit {{ $product->name }}</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-end">
                            <li class="breadcrumb-item"><a href="#">Home</a></li>
                            <li class="breadcrumb-item"><a
                                    href="{{ route('vendor.products.index', app()->getLocale()) }}">Products</a>
                            </li>
        ...
        <div class="card card-info card-outline mb-4">
            <!--begin::Form-->
            <form form
                action="{{ route('vendor.products.update', ['lang' => app()->getLocale(), 'product' => $product->id]) }}"
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        <!--begin::Col-->
                        <input type="hidden" name="vendor_id" class="form-control" value="{{ $product->vendor_id }}" />
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="sku" value="{{ old('sku', $product->sku ?? '') }}"
                                class="form-control" id="sku" required />
                            @error('sku')
                                <p class="msg-error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="tags"
                                value="{{ old('tags', $product->tags ? implode(',', json_decode($product->tags)) : '') }}"
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" step="any" name="width"
                                value="{{ old('width', $product->width ?? '') }}" class="form-control" id="width" />
                            @error('width')
                                <p class="msg-error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" step="any" name="height"
                                value="{{ old('height', $product->height ?? '') }}" class="form-control"
                                id="height" />
                            @error('height')
                                <p class="msg-error">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" step="any" name="length"
                                value="{{ old('length', $product->length ?? '') }}" class="form-control"
                                id="length" />
                            @error('length')
                                <p class="msg-error">{{ $message }}</p>
                            @enderror
