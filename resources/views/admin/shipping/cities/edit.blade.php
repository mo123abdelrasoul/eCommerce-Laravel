    ...
    <div class="dashboard-container flex min-h-screen">
        ...
        <div class="app-content-header">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <h3 class="mb-0">Edit City: {{ $city->name }}</h3>
                    </div>
                    <div class="col-sm-6">
        ...
        <div class="card card-info card-outline mb-4">
            <!--begin::Form-->
            <form form action="{{ route('admin.cities.update', ['lang' => app()->getLocale(), 'city' => $city->id]) }}"
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="is_active" id="is_active" class="form-select" required>
                                <option value="1"
                                    {{ old('is_active', $city->is_active ?? 1) == 1 ? 'selected' : '' }}>
                                    Active
                                </option>
                                <option value="0"
                                    {{ old('is_active', $city->is_active ?? 1) == 0 ? 'selected' : '' }}>
                                    Disabled</option>
                            </select>
                            @error('is_active')
                                <p class="msg-error">{{ $message }}</p>
                    ...
                    <div class="card-footer">
                        <button class="btn btn-info" type="submit">Update city</button>
                    </div>
                    <!--end::Footer-->
            </form>
            <!--end::Form-->
