...
@section('content')
    ...
    <div class="dashboard-container flex min-h-screen">
        ...
        <div class="card card-info card-outline mb-4">
            <!--begin::Form-->
            <form form
                action="{{ route('admin.products.update', ['lang' => app()->getLocale(), 'product' => $product->id]) }}"
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-select" name="deleted" id="deleted">
                                <option value="0" {{ $product->deleted_at == null ? 'selected' : '' }}>No</option>
                                <option value="1" {{ $product->deleted_at != null ? 'selected' : '' }}>Yes</option>
                            </select>
                        </div>
                        <!--end::Col-->
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="admin_feedback"
                                value="{{ old('admin_feedback', $product->admin_feedback ?? '') }}" class="form-control"
                                id="admin_feedback" />
