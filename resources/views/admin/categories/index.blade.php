                ...
                <div class="col-md-12">
                    ...
                    <div class="card mb-12">
                        <div class="d-flex justify-content-between align-items-center mb-3 p-3">
                            <form action="{{ route('admin.categories.index', ['lang' => app()->getLocale()]) }}"
                            ...
                            <a href="{{ route('admin.categories.create', ['lang' => app()->getLocale()]) }}"
                                class="btn btn-success">Create Category</a>
                        </div>
                        <!-- /.card-header -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-warning"
                                                    href="{{ route('admin.categories.edit', ['category' => $category->id, 'lang' => app()->getLocale()]) }}">
                                                    Edit
                                                </a>
                                                <form
                                                    action="{{ route('admin.categories.destroy', ['category' => $category->id, 'lang' => app()->getLocale()]) }}"
