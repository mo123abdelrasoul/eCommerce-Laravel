                ...
                <div class="col-md-12">
                    ...
                    <div class="card mb-12">
                        <div class="d-flex justify-content-between align-items-center mb-3 p-3">
                            <form action="{{ route('admin.brands.index', ['lang' => app()->getLocale()]) }}" method="GET"
                                class="d-flex">
                            ...
                            <a href="{{ route('admin.brands.create', ['lang' => app()->getLocale()]) }}"
                                class="btn btn-success">Create Brand</a>
                        </div>
                        <!-- /.card-header -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-warning   "
                                                    href="{{ route('admin.brands.edit', ['brand' => $brand->id, 'lang' => app()->getLocale()]) }}">
                                                    Edit
                                                </a>
                                                <form
                                                    action="{{ route('admin.brands.destroy', ['brand' => $brand->id, 'lang' => app()->getLocale()]) }}"
