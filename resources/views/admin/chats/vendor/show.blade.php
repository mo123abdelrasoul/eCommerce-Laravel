...
@section('content')
    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('admin.vendor-chats.index', app()->getLocale()) }}" class="btn btn-secondary btn-sm">← Back</a>
        </div>
        ...
        <div class="card" style="display: flex; flex-direction: column; height: 400px;">
            ...
            <div class="card-footer bg-light border-0 shadow-sm">
                <form
                    action="{{ route('admin.chats.vendor-chat.send.message', ['lang' => app()->getLocale(), 'receiverId' => $chat['id'] ?? 1]) }}"
...
@push('scripts')
    <script>
        ...
        const adminSendMessageUrl =
            "{{ route('admin.chats.vendor-chat.send.message', ['lang' => app()->getLocale(), 'receiverId' => $vendorId]) }}";
    </script>
